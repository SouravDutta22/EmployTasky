                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-3 flex space-x-3">
                            <button 
                                ...
                                className={`${isProcessing ? 'bg-gray-600' : 'bg-green-600 hover:bg-green-700'} text-white px-4 py-1 rounded-md text-sm`}
                            >
                            ...
                            <button 
                                ...
                                disabled={isProcessing}
                                className={`${isProcessing ? 'bg-gray-600' : 'bg-red-600 hover:bg-red-700'} text-white px-4 py-1 rounded-md text-sm`}
                            >
                ...
                {notifications.length > 0 ? (
                    <ul className="space-y-4">
                        {notifications.map((notification) => (
                            <li key={notification.id} className="bg-gray-700 p-4 rounded-md">
                    ...
                    <div className="text-center py-10">
                        ...
                        <p className="text-xl text-gray-400">No notifications</p>
